        ...
        case LLAMA_POOLING_TYPE_RANK:
            {
                ...
                if (cls) {
                    ...
                    // Activation by arch: DistilBERT ReLU, ModernBERT GELU, others tanh.
                    // The ReLU branch is a local addition (Caelus DistilBERT classifier
                    // head); the rest follows upstream after the rebase.
